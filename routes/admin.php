...
Route::middleware(['auth' , 'is_admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('agents/{agent}/invoice',                    [InvoiceController::class , 'index'])       ->name('agent.invoice.index');
    Route::get('agents/{agent}/invoice/{invoice}/edit',     [InvoiceController::class , 'edit'])        ->name('agent.invoice.edit');
    Route::patch('agents/{agent}/invoice/{invoice}',        [InvoiceController::class , 'update'])      ->name('agent.invoice.update');
    Route::delete('agents/{agent}/invoice/{invoice}',       [InvoiceController::class , 'destroy'])     ->name('agent.invoice.destroy');
