@extends('admin.layout.master' , ['title' => 'تاریخچه پیامک ها'])
...
@section('subheader')
    ...
    @endphp
    <x-dashboard.subheader :links='$buttons ?? []' :title="'تاریخچه پیامک ها'" />
@endsection
                ...
                <div class="table-responsive-sm">
                    <table class="table ">
                        ...
                        <tr class="text-muted">
                            ...
                            <th class="text-center">متن پیامک</th>
                            <th class="text-center">زمان ارسال</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach($smslogs as $key=>$log)
                            <tr>
                                <td class="text-center align-middle"> {{$key+1}} </td>
                                <td class="text-center align-middle"> {{$log->agent->fullname}} </td>
                                <td class="text-center align-middle text-nowrap">{{$log->text}} </td>
