@extends('agent.layout.master' , ['title' => 'پروفایل مشتری'])
@section('title' , 'پروفایل مشتری')
@section('subheader')
    @php

    @endphp
    <x-dashboard.subheader :links='[]' :title="' پروفایل ' . $customer->fullname" />
@endsection
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                            <div class="navi-item mb-2">
                                <a href="{{route('agent.customer.show' , $customer->id)}}" class="navi-link py-4 active">
                            ...
                            <div class="navi-item mb-2">
                                <a  href="{{route('agent.customer.edit' , $customer->id)}}" class="navi-link py-4 ">
                                <span class="navi-icon mr-2">
                                    <span class="svg-icon">
                            ...
                            {{--                            <div class="navi-item mb-2">--}}
                            {{--                                <a  href="{{route('agent.agent.invoice.index' , ['agent' =>  $customer->id])}}" class="navi-link py-4 ">--}}
                            {{--                                <span class="navi-icon mr-2">--}}
                            {{--                                    <span class="svg-icon">--}}
                            {{--                                        <!--begin::Svg Icon | path:assets/media/svg/icons/عمومی/User.svg-->--}}
                            ...
                            <div class="card card-custom @if($salesCase->failure_reason_id)bg-light-danger @endif @if($salesCase->is_promoted) border border-left-warning border-5 @endif mt-3">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="text-center col bg-light-primary px-6 py-8 rounded-xl mb-7"><span class="svg-icon svg-icon-3x svg-icon-primary d-block my-5"><x-dashboard.icons.svg.money/></span>
