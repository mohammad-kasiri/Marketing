@extends('agent.layout.master' , ['title' => 'ویرایش اطلاعات مشتری'])
    ...
    @php
        $buttons = [
            [
                ...
                'route'  =>  route('agent.customer.show' , $customer->id) ,
                    ...
                    <div class="kt-grid__item">
                        ...
                        <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                            <div class="col-xl-12 col-xxl-7">
                                ...
                                <form class="form" action="{{route('agent.customer.update' , $customer->id)}}" method="post">
                                    @csrf
                                    @method('PATCH')
