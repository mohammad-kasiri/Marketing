...
@section('content')
    <div class="container-fluid mt-3">
        ...
        <div class="card card-custom">
            ...
            <div class="card-body">
                <form action="{{route('agent.invoice.store.without-customer')}}" method="post"> @csrf
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <x-dashboard.form.row-input label="نام مشتری" name="customer_fullname" type="text"/>
                        </div>
                        <div class="col-md-8">
                            <x-dashboard.form.row-input label="شماره تماس مشتری" name="customer_mobile" type="text" value="{{$mobile}}" disabled="true"/>
                            <input type="hidden" name="customer_mobile"  value="{{$mobile}}">
                        </div>
                        <div class="col-md-8">
                            <x-dashboard.form.row-input label="ایمیل مشتری" name="customer_email" type="email"/>
                        </div>
