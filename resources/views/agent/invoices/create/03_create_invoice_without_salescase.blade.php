    ...
    <div class="container-fluid mt-3">
        @if(request()->has('salesCase'))
            <div class="alert alert-custom alert-light-primary fade show mb-5" role="alert">
                ...
                <div class="alert-text">ایجاد رسید </div>
            </div>
        @endif
        @error('products')
        ...
        <div class="card card-custom">
            ...
            <div class="card-body">
                <form action="{{route('agent.invoice.store.without-sales-case')}}" method="post"> @csrf
                    <input type="hidden" name="customer" value="{{$customer->id}}"/>
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <x-dashboard.form.row-input label="نام مشتری" name="customer_fullname" type="text" value="{{$customer->fullname}}" disabled="true"/>
                        </div>
                        <div class="col-md-8">
                            <x-dashboard.form.row-input label="شماره تماس مشتری" name="customer_mobile" type="text" value="{{$customer->mobile}}" disabled="true"/>
                        </div>
                        <div class="col-md-8">
                            <x-dashboard.form.row-input label="ایمیل مشتری" name="customer_email" type="email"  value="{{$customer->email}}" disabled="true"/>
                        </div>
